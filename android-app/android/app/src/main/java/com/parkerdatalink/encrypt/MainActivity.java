package com.parkerdatalink.encrypt;
 ...
 * message tools are never covered.
 *
 *   Banner       a sibling BELOW the WebView, never an overlay.
 *   App open     only when returning to an app that was already warm.
 *   No interstitials — a full-screen ad mid-encrypt would be maddening.
 */
public class MainActivity extends BridgeActivity {

    private static final String BANNER_ID       = "ca-app-pub-2328685696786328/4974202025";
    private static final String INTERSTITIAL_ID = "";
    private static final String APP_OPEN_ID     = "ca-app-pub-2328685696786328/3719806007";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getBridge().getWebView().addJavascriptInterface(new WebBridge(), "VaultAds");
